...
function keys_function1(display_stuff) {
    var ec = new elliptic.ec('secp256k1');
    var keys_internal = new_keys();
    //var div = document.createElement("div");
    if(display_stuff){
        var div = document.getElementById("pubkey");
    } else {
        var div = document.createElement("div");
    };
    ...
    //div.appendChild(br());
    if(display_stuff){
        var save_button = button_maker2("Saves the private key to a file.", save_keys);
        //div.appendChild(br());
    }
